...
{
       0,    57,    57,    57,    58,    62,    63,    63,    67,    68,
      69,    69,    73,    74,    73,    95,    96,    97,   103,   103,
     107,   107,   111,   115,   116,   117,   118
};
#endif
...
{
  "$end", "error", "$undefined", "CONST", "INT", "FLT", "CHR", "EQUAL",
  "SCOLON", "INTEGER", "FLOAT", "CHARACTER", "IDENTIFIER", "PLUS", "MINUS",
  "$accept", "program", "$@1", "sentence", "$@2", "declaration", "$@3",
  "assignment", "$@4", "$@5", "data_type", "expr", "$@6", "$@7",
  "expr_element", YY_NULLPTR
};
#endif
...
{
       0,    14,    22,   -15,    -1,   -15,   -15,   -15,     0,    10,
     -15,   -15,   -15,   -15,    11,    -3,   -15,   -15,     3,   -15,
     -15,   -15,   -15,   -15,   -15,     4,    12,   -15,    17,   -15,
     -15,   -15,   -15,    -3,    -3,   -15,   -15
};
...
{
       6,     0,     0,     2,     0,     5,    12,     1,     6,     0,
      15,    16,    17,     7,     0,     0,     3,    10,     0,     9,
      23,    24,    25,    26,    13,    22,     0,     8,     0,    18,
      20,    11,    14,     0,     0,    19,    21
};
...
{
      -4,    19,     9,    10,    11,    12,    20,    21,    22,    23,
       6,    27,     1,    31,    10,    11,    12,    29,    30,    35,
      36,     6,     7,    18,     1,    32,    16,     0,    17
};

static const yytype_int8 yycheck[] =
{
       0,    14,     3,     4,     5,     6,     9,    10,    11,    12,
       7,     8,    12,    26,     4,     5,     6,    13,    14,    33,
      34,     7,     0,    12,    12,     8,     8,    -1,     9
};
...
{
       0,    12,    16,    18,    19,    22,     7,     0,    17,     3,
       4,     5,     6,    20,    25,    23,    16,    25,    12,    22,
       9,    10,    11,    12,    26,    29,    21,     8,    24,    13,
      14,    22,     8,    27,    28,    29,    29
};
...
{
       0,    15,    17,    16,    16,    18,    19,    18,    20,    20,
      21,    20,    23,    24,    22,    25,    25,    25,    27,    26,
      28,    26,    26,    29,    29,    29,    29
};
...
#line 67 "y.y" /* yacc.c:1646  */
    {declare((yyvsp[-1].varName),currentDataType);}
...
#line 1313 "y.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 74 "y.y" /* yacc.c:1646  */
    { rhsType = currentType;}
#line 1319 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 75 "y.y" /* yacc.c:1646  */
    { 
                if (rhsType != -9) {
                        if(declaring)
                                if (rhsType == currentDataType || rhsType == currentDataType + 3 || rhsType == currentDataType -3)
                                { 
                                        declare((yyvsp[-5].varName),currentDataType);
                                        lhsType = currentDataType;
                                }
                        else {lhsType = getType((yyvsp[-5].varName));}
                        if (assign((yyvsp[-5].varName), lhsType, rhsType)) {
                                fprintf(assembly,"\n MOV %s , R%d", (yyvsp[-5].varName) ,regCount);
                                setVariable((yyvsp[-5].varName));
                                }
...
#line 1359 "y.tab.c" /* yacc.c:1646  */
  ...
  case 18:
#line 103 "y.y" /* yacc.c:1646  */
    {firstOperandType = currentType; firstReg = regCount++;}
#line 1365 "y.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 103 "y.y" /* yacc.c:1646  */
    { if(validateAssign(firstOperandType, currentType,true)) {
                                                                                                        secondReg = regCount++; 
...
#line 1389 "y.tab.c" /* yacc.c:1646  */
  ...
  case 23:
#line 115 "y.y" /* yacc.c:1646  */
    { currentType = 0; fprintf(assembly,"\n MOV R%d, %d",regCount, (yyvsp[0].iValue));}
#line 1395 "y.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 116 "y.y" /* yacc.c:1646  */
    { currentType = 1; fprintf(assembly,"\n MOV R%d, %f", regCount,(yyvsp[0].fValue) );}
#line 1401 "y.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 117 "y.y" /* yacc.c:1646  */
    { currentType = 2; fprintf(assembly,"\n MOV R%d, '%c'",regCount,(yyvsp[0].cValue) );}
#line 1407 "y.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 118 "y.y" /* yacc.c:1646  */
    { if(existAndInitialized((yyvsp[0].varName))) {
                  currentType = getType((yyvsp[0].varName));fprintf(assembly,"\n MOV R%d, %s",regCount, (yyvsp[0].varName));
                  } else {
                        currentType = -9;
                        }  
                  }
